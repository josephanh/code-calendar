      ...
      function easterGregorian(year) {
        ...
        if (year < 1583 || year > 4099)
          throw new Error("Year must be 1583..4099");
        const a = year % 19;
      ...
      function buildLiturgicalYearForEasterYear(easterYear) {
        ...
        function pushItem(sundayName, weekNumber, ymd, label, prority = 0) {
          if (prority === 1) {
            let dayFeast = items.find(
              (i) => i.m === ymd.month && i.d === ymd.day
            );
            if (dayFeast) {
        ...
        // 3) MÙA THỨNG NIEN: CN I Mùa Thường Niên -> CN VII Mùa Thường Niên (thường 7 CN, tuỳ năm)
        ...
        while (true) {
          ...
          const name = `Chúa Nhật ${Roman(weekCountOrdinary)} Mùa Thường Niên`;
        ...
        while (true) {
          ...
          pushItem(name, weekCount, curLent, "");
        ...
        pushItem("Chúa Nhật Lễ Lá (CN Tuần Thánh)", null, palm, "Bắt đầu Tuần Thánh");
        pushItem(
        ...
        pushItem(
          "Thứ Sáu Tuần Thánh (Đóng Đinh)",
          null,
          goodFriday,
          "Tuần Thánh"
        );
        pushItem(
          "Thứ Bảy Tuần Thánh (Canh Thức Phục Sinh)",
          null,
          holySaturday,
          "Tuần Thánh"
        );
        ...
        for (let w = 2; w <= 7; w++) {
          ...
          const name =
            w === 1
              ? `Chúa Nhật Phục Sinh`
              : `Chúa Nhật ${Roman(w)} Mùa Phục Sinh`;
          pushItem(name, w, dt, "");
        }
        ...
        while (true) {
          ...
          pushItem(name, weekCountOrdinary, dateToYMD(christDate), name);
        ...
        // Pentecost Sunday
        pushItem("Chúa Nhật Lễ Hiện Xuống (Pentecost)", null, pentecost, "", 1);

        // Trinity Sunday (CN sau Hiện Xuống)
        pushItem("Chúa Nhật Lễ Chúa Ba Ngôi", null, trinity, "", 1);
        ...
        // Add Christ the King
        pushItem(
          "Chúa Nhật XXXIV Thường Niên Lễ Chúa Kitô Vua Vũ Trụ (Christ the King)",
          34,
          christTheKingDate,
